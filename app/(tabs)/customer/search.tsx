...
// // Grid Background Component with both horizontal and vertical lines
...
//           <Ionicons name={isShop ? "storefront" : "cube"} size={24} color="rgba(23, 104, 217, 1)" />
//         </View>
//       )}
...
//   // Smooth search function with animation
...
//                   duration: 300,
//                   useNativeDriver: true,
//                 }).start(() => router.push(item.route as any));
//               }
//             }}
//           >
...
//   container: {
//     flex: 1,
//     backgroundColor: 'rgba(208, 226, 250, 1)',
//   },
...
//   gridLine: {
//     position: 'absolute',
//     backgroundColor: 'rgba(144, 186, 242, 0.15)',
//   },
//   gridLineVertical: {
//     width: 1,
//     height: '100%',
...
//     paddingVertical: 16,
//     backgroundColor: 'rgba(208, 226, 250, 0.95)',
//     borderBottomWidth: 1,
...
//     bottom: 0,
//     width: '80%',
//     backgroundColor: 'rgba(208, 226, 250, 0.98)',
//     zIndex: 1000,
//     shadowColor: 'rgba(4, 18, 36, 0.2)',
...
export default function SearchScreen() {
  ...
  // Optimized search function without artificial delays
  const handleSearch = async (queryText: string = searchQuery) => {
    const searchText = queryText.trim();
    if (!searchText) {
      setSearchResults([]);
