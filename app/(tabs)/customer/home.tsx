...
//   border: '#e2e8f0',
//   darkButton: '#1e293b',
//   needColor: '#8b5cf6', // Changed from brown to purple
//   offerColor: '#06b6d4', // Changed from green to cyan
...
//   gradientNeed: ['#8b5cf6', '#a78bfa'] as const, // New gradient for needs
//   gradientOffer: ['#06b6d4', '#22d3ee'] as const, // New gradient for offers
...
// // UPDATED: Enhanced Product Card with Star Ratings and fixed decimal
...
//   // Fixed: Rating with only one decimal place
...
//         {/* Rating Section - FIXED: Now shows only one decimal */}
...
// // ENHANCED Customer Post Card Component with Modern Design
...
//       ]}
//     >
//       {/* Enhanced Post Header with Modern Design */}
//       <LinearGradient
...
//                   { 
//                     backgroundColor: item.type === 'NEED' 
...
//               <View style={[styles.detailIcon, { backgroundColor: getTypeColor() + '20' }]}>
...
//           <View style={styles.detailItem}>
//             <View style={[styles.detailIcon, { backgroundColor: getTypeColor() + '20' }]}>
//               <Ionicons name="location" size={14} color={getTypeColor()} />
//             </View>
...
//           <View style={styles.detailItem}>
//             <View style={[styles.detailIcon, { backgroundColor: getTypeColor() + '20' }]}>
//               <Ionicons name="time" size={14} color={getTypeColor()} />
//             </View>
...
//               <Ionicons name="person" size={10} color={getTypeColor()} />
