...
//   // Get the correct image URL - handle both image and imageUrl fields with priority
//   const getImageUrl = (): string => {
//     if (!productData) {
//       return 'https://via.placeholder.com/400x300?text=No+Image+Available';
//     }

//     // Check both image and imageUrl fields with priority to imageUrl
//     const possibleUrls = [
//       productData.imageUrl, // First priority
//       productData.image,    // Second priority
//     ];
...
//     if (imageError || !isValidUrl(imageUrl)) {
//       return (
//         <View style={styles.imageError}>
//           <Ionicons name="image-outline" size={50} color={colors.textSecondary} />
//           <Text style={styles.imageErrorText}>Image not available</Text>
//           <Text style={styles.imageErrorSubText}>The product image could not be loaded</Text>
//         </View>
//       );
//     }
...
//COMPLETE productdetails.tsx CODE - COPY AND PASTE THIS INTO YOUR productdetails.tsx FILE:
